      ...
      <div className="px-6 pt-4">
        <ul className="flex flex-col space-y-2">
          ...
          <li className="relative text-gray-500 hover:text-white focus-within:text-white">
            ...
            <a  href="#" className="inline-block w-full py-2 pl-8 pr-4 text-xs rounded hover:bg-gray-800 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:bg-gray-800">Reporting</a>
          </li>
          <li className="relative text-gray-500 hover:text-white focus-within:text-white">
            <div
              className="absolute inset-y-0 left-0 flex items-center pl-2 pointer-events-none"
